#!/bin/bash
#SBATCH --job-name=hpl_intel_1_iter1
#SBATCH --partition=Mini-Caribou
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --time=00:30:00
#SBATCH --output=case_setups/case_027/run/iter_1/hpl_intel_1_iter1.out

echo "===== JOB START ====="
echo "Running hpl | intel | Threads=1"
...
cd $SLURM_SUBMIT_DIR/benchmarks/hpl/intel
