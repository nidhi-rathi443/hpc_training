#!/bin/bash
#SBATCH --job-name=hpcg_aocc_1
#SBATCH --partition=Mini-Caribou
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --time=00:30:00
#SBATCH --output=benchmarks/hpcg/aocc/logs/hpcg_aocc_1.out
#SBATCH --error=benchmarks/hpcg/aocc/logs/hpcg_aocc_1.out

echo "===== JOB START ====="
echo "Running hpcg | aocc | Threads=1"
