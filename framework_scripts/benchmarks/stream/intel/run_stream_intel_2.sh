#!/bin/bash
#SBATCH --job-name=stream_intel_2
#SBATCH --partition=Mini-Caribou
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=2
#SBATCH --time=00:30:00
#SBATCH --output=benchmarks/stream/intel/logs/stream_intel_2.out
#SBATCH --error=benchmarks/stream/intel/logs/stream_intel_2.out

echo "===== JOB START ====="
echo "Running stream | intel | Threads=2"
