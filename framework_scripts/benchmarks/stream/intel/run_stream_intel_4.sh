#!/bin/bash
#SBATCH --job-name=stream_intel_4
#SBATCH --partition=Mini-Caribou
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --time=00:30:00
#SBATCH --output=benchmarks/stream/intel/logs/stream_intel_4.out
#SBATCH --error=benchmarks/stream/intel/logs/stream_intel_4.out
